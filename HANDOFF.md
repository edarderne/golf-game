...
> State as of 2026-07-07. Everything below is committed to
...
| File | Purpose |
| --- | --- |
| `index.html` | All screens (home/creator, lobby, game, tournament) + overlays (summary, scorecard, menu, leaderboard, final) |
...
| `js/course.js` | Seeded hole generation: terrain, fairway/island polygons, green slope, ALL decor (pines/leafy/palms with facet params, boulders+capstones, moai, props, speckle, patches) |
| `js/physics.js` | Clubs, deterministic shot/roll sim, green-slope break, hole capture (slow rolls only) |
| `js/ambient.js` | Visual wildlife: birds, shore fish, rare whale (~60-90s), pond ducks, beach turtle, wandering deer, ultra-rare sprinting yeti (~8-10 min) |
...
elements and inconsistent shadows.
